...
export default {
  ...
  methods: {
    ...
    addToCart(prodItem) {
      ...
      axiosBase
        ...
        .then((res) => {
            ...
            this.showToast(true, res.data.message, res.data.type, res.data.color, "Add to cart")
        })
    ...
    downloadItem(prodItem) {
        ...
        this.showToast(true, `${prodItem.file.name} was downloaded successfully!`, "success", "green", "Download")
